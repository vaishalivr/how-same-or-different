...
var app = (function () {
    ...
    /* src/titleContainer.svelte generated by Svelte v3.59.2 */
    const file$2 = "src/titleContainer.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "id", "svg-title-container");
    			attr_dev(div, "class", "svelte-19erlr8");
    			add_location(div, file$2, 40, 0, 1154);
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	validate_slots('TitleContainer', slots, []);
    	...
    	onMount(() => {
    		...
    		const svg = select("#svg-title-container").append("svg").attr("width", "100%").attr("height", "100%").attr("viewBox", `0 0 ${width} ${height}`).style("border", "1px solid black");

    		for (let row = 0; row < rows; row++) {
    			for (let col = 0; col < cols; col++) {
    				svg.append("rect").attr("width", rectWidth).attr("height", rectHeight).attr("x", startX + col * (rectWidth + spacing)).attr("y", startY + row * (rectHeight + spacing)).attr("fill", "none").attr("stroke", "black");
    			}
    		}
    	});
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<TitleContainer> was created with unknown prop '${key}'`);
    	});
    ...
    class TitleContainer extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    var scrollamaExports = scrollama$1.exports;
    var scrollama = /*@__PURE__*/getDefaultExportFromCjs(scrollamaExports);

    /* src/scrollTitle.svelte generated by Svelte v3.59.2 */

    const { console: console_1 } = globals;
    const file$1 = "src/scrollTitle.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h1 = element("h1");
    			h1.textContent = "How Same or Different Are We";
    			t1 = space();
    			...
    			div5 = element("div");
    			div5.textContent = "this is outside the scrollying";
    			set_style(h1, "margin-bottom", "300px");
    			add_location(h1, file$1, 72, 4, 2104);
    			attr_dev(section0, "id", "intro");
    			add_location(section0, file$1, 71, 2, 2079);
    			attr_dev(p0, "class", "svelte-qjtf8d");
    			add_location(p0, file$1, 79, 8, 2348);
    			attr_dev(div0, "class", "step svelte-qjtf8d");
    			attr_dev(div0, "data-step", "1");
    			add_location(div0, file$1, 78, 6, 2307);
    			attr_dev(p1, "class", "svelte-qjtf8d");
    			add_location(p1, file$1, 87, 8, 2697);
    			attr_dev(div1, "class", "step svelte-qjtf8d");
    			attr_dev(div1, "data-step", "2");
    			add_location(div1, file$1, 86, 6, 2656);
    			attr_dev(p2, "class", "svelte-qjtf8d");
    			add_location(p2, file$1, 95, 8, 3046);
    			attr_dev(div2, "class", "step svelte-qjtf8d");
    			attr_dev(div2, "data-step", "3");
    			add_location(div2, file$1, 94, 6, 3005);
    			attr_dev(p3, "class", "svelte-qjtf8d");
    			add_location(p3, file$1, 103, 8, 3395);
    			attr_dev(div3, "class", "step svelte-qjtf8d");
    			attr_dev(div3, "data-step", "4");
    			add_location(div3, file$1, 102, 6, 3354);
    			attr_dev(article, "class", "svelte-qjtf8d");
    			add_location(article, file$1, 77, 4, 2291);
    			attr_dev(div4, "class", "sticky-thing svelte-qjtf8d");
    			attr_dev(div4, "id", "svg-title-container");
    			add_location(div4, file$1, 112, 4, 3717);
    			attr_dev(section1, "id", "scrolly");
    			attr_dev(section1, "class", "svelte-qjtf8d");
    			add_location(section1, file$1, 76, 2, 2264);
    			add_location(div5, file$1, 115, 22, 3811);
    			attr_dev(section2, "id", "outro");
    			add_location(section2, file$1, 115, 2, 3791);
    			add_location(main, file$1, 70, 0, 2070);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('ScrollTitle', slots, []);
    	...
    	onMount(() => {
    		...
    		scrolly.querySelector(".sticky-thing");
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<ScrollTitle> was created with unknown prop '${key}'`);
    	});

    	$$self.$capture_state = () => ({ onMount, d3, scrollama });
    	return [];
    }

    class ScrollTitle extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_fragment(ctx) {
    	...
    	let scrolltitle;
    	let current;
    	scrolltitle = new ScrollTitle({ $$inline: true });

    	const block = {
    		c: function create() {
    			main = element("main");
    			create_component(scrolltitle.$$.fragment);
    			attr_dev(main, "class", "svelte-fczn83");
    			add_location(main, file, 5, 0, 126);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, main, anchor);
    			mount_component(scrolltitle, main, null);
    			current = true;
    		},
    		p: noop$4,
    		i: function intro(local) {
    			if (current) return;
    			transition_in(scrolltitle.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(scrolltitle.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(main);
    			destroy_component(scrolltitle);
    		}
    	};
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ TitleContainer, ScrollTitle });
    	return [];
    }
